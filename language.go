...
func (l *Language) Copy() *Language {
	return NewLanguage(unsafe.Pointer(C.ts_language_copy((*C.TSLanguage)(l.ptr))))
}
...
func (l *Language) SymbolType(s Symbol) SymbolType {
	return SymbolType(C.ts_language_symbol_type((*C.TSLanguage)(l.ptr), s)) //nolint:unconvert // ok
}
